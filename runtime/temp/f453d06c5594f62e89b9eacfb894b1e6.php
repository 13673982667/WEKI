<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:49:"./template/mobile/rainbow/goods\categoryList.html";i:1530846810;s:63:"D:\phpStudy\WWW\shop\template\mobile\rainbow\public\header.html";i:1530846810;s:64:"D:\phpStudy\WWW\shop\template\mobile\rainbow\public\top_nav.html";i:1530846810;s:67:"D:\phpStudy\WWW\shop\template\mobile\rainbow\public\footer_nav.html";i:1530846810;s:65:"D:\phpStudy\WWW\shop\template\mobile\rainbow\public\wx_share.html";i:1530846810;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
                ...
                <div class="branchList" >
                    ...
                    <!--广告图-s-->
	                    <div class="tp-bann"  data-id="<?php echo $j++; ?>">
	                        <?php $pid =401;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1534989600 and end_time > 1534989600 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
    ...
    ?>
	                    ...
	                    <div class="tp-class-list">
	                        <?php if(is_array($vo['tmenu']) || $vo['tmenu'] instanceof \think\Collection || $vo['tmenu'] instanceof \think\Paginator): if( count($vo['tmenu'])==0 ) : echo "" ;else: foreach($vo['tmenu'] as $k2=>$v2): ?>
	                                <h4><a href="<?php echo U('Mobile/Goods/goodsList',array('id'=>$v2[id])); ?>" ><?php echo $v2['mobile_name']; ?></a></h4>
