<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:43:"./template/pc/rainbow/order\order_list.html";i:1530846811;s:57:"D:\phpStudy\WWW\shop\template\pc\rainbow\user\header.html";i:1530846812;s:55:"D:\phpStudy\WWW\shop\template\pc\rainbow\user\menu.html";i:1530846812;s:59:"D:\phpStudy\WWW\shop\template\pc\rainbow\public\footer.html";i:1530846811;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                        ...
                        <?php else: if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                            <table width="100%" border="" cellspacing="" cellpadding="">
                                <tr class="time_or">
                                    <td colspan="6">
                                        <div class="fl_ttmm">
                                            <span class="time-num">下单时间<?php echo $list['cancel_info']; ?>：<em class="num"><?php echo date('Y-m-d H:i:s',$list['add_time']); ?></em></span>
                                ...
                                <?php if(is_array($list['goods_list']) || $list['goods_list'] instanceof \think\Collection || $list['goods_list'] instanceof \think\Paginator): $k = 0; $__LIST__ = $list['goods_list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goods): $mod = ($k % 2 );++$k;if($k == 1): ?>
                                        <tr class="conten_or">
                                            ...
                                            <td class="sx6" rowspan="<?php echo count($list['goods_list']); ?>">
                                                <div class="rbac">
                                                    <p class=""><a class="buy_order" data-order-id="<?php echo $list['order_id']; ?>" href="javascript:;">再次购买</a></p>
