<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"./application/admin/view/order\add_order.html";i:1530846802;s:62:"D:\phpStudy\WWW\shop\application\admin\view\public\layout.html";i:1530846802;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <form class="form-horizontal" action="<?php echo U('Admin/Order/addOrder'); ?>" id="order-add" method="post">
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" name="invoice_title" value="<?php echo $order['invoice_title']; ?>" class="input-txt"  placeholder="发票抬头" maxlength="20"/>
                </dd>
            </dl>
            <dl class="row">
                <dt class="tit">
