<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"./application/admin/view/order\delivery_info.html";i:1530846802;s:62:"D:\phpStudy\WWW\shop\application\admin\view\public\layout.html";i:1530846802;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
 ...
 <form id="delivery-form" action="<?php echo U('Admin/order/deliveryHandle'); ?>" method="post">
     <input type="hidden" id="shipping" name="shipping" value="<?php echo $order['shipping_status']; ?>">
        ...
        <div class="contact-info"  style="margin-top:10px;">
          ...
          <dl class="row">
	        ...
	        <input type="hidden" name="order_id" value="<?php echo $order['order_id']; ?>">
	         <textarea id="note" name="note" style="width:600px" rows="6" maxlength="200" placeholder="请输入操作备注" class="tarea" id="note"><?php echo $keyword['text']; ?></textarea>
	        </dd>
	      </dl> 
	      <dl class="row">
	        <dt class="tit">
