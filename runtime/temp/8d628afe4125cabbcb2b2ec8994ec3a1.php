<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:48:"./application/admin/view/order\virtual_list.html";i:1530846802;s:62:"D:\phpStudy\WWW\shop\application\admin\view\public\layout.html";i:1530846802;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <div class="item-title">
      <div class="subject">
		...
		<ul class="tab-base nc-row">
			<li><a class="current" href="<?php echo U('admin/Order/virtual_list'); ?>"><span>虚拟订单</span></a></li>
			<li><a class="" href="<?php echo U('admin/Order/verify_code'); ?>"><span>兑换码兑换</span></a></li>
		</ul>
    </div>
  </div>
  <!-- 操作说明 -->
  ...
  <div class="flexigrid">
    <div class="mDiv">
	  ...
	  <form class="navbar-form form-inline"  method="post" action="<?php echo U('Order/export_order'); ?>"  name="search-form2" id="search-form2">
