<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:45:"./template/pc/rainbow/order\order_detail.html";i:1530846811;s:57:"D:\phpStudy\WWW\shop\template\pc\rainbow\user\header.html";i:1530846812;s:59:"D:\phpStudy\WWW\shop\template\pc\rainbow\public\footer.html";i:1530846811;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
        ...
        <div class="home-main">
            <div class="com-topyue">
                <div class="wacheng fl">
                    ...
                    <?php if($order['prom_type'] == 4 AND !empty($order['pre_sell_info']['pre_sell_retainage_end'])): ?>
                        <p class="ddn1"><span>订单类型：</span><span>预售订单&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></p>
                        <p class="ddn1"><span>尾款支付结束时间：</span>
                            <span><?php echo date('Y-m-d H:i:s',$order['pre_sell_info']['pre_sell_retainage_end']); ?></span>
                        </p>
                        <?php if($order['pre_sell_info']['pre_sell_is_finished'] == 2): ?>
                        ...
                        <?php endif; if($order['pre_sell_info']['pre_sell_is_finished'] == 1): if(time() > $order['pre_sell_info']['pre_sell_retainage_end']): ?>
                                <p class="ddn1"><span>关闭原因：</span><span>已过支付尾款时间</span></p>
                                <h3 style="font: 700 24px/34px 'Microsoft YaHei';color: #e4393c; padding-top:20px;">订单关闭</h3>
                            <?php endif; endif; endif; if($order['order_button']['pay_btn'] == 1): ?>
                    ...
                    <?php endif; if($order['order_button']['cancel_btn'] == 1): if($order[pay_status] == 0): ?>
                        ...
                        <?php endif; endif; if($order['prom_type'] == 4 AND $order['pay_status'] == 2 AND $order['pre_sell_info']['pre_sell_is_finished'] == 1 AND (time() >= $order['pre_sell_info']['pre_sell_retainage_start'] AND time() <= $order['pre_sell_info']['pre_sell_retainage_end'])): ?>
                ...
                <div class="wacheng2 fr">
                    ...
                    <div class="liuchaar p">
                        <ul>
                            ...
                            <li><i class='y-comp91 <?php if(($order['shop_id'] == 0 and $order[shipping_time] == 0) or $order[shop_order][is_write_off] == 0): ?>top322<?php endif; ?>'></i></li>
                            <li>
                                <div class="aloinfe fime2">
                                    <i class='y-comp3 <?php if(($order['shop_id'] == 0 and $order[shipping_time] == 0) or $order[shop_order][is_write_off] == 0): ?>lef64<?php endif; ?>'></i>
                                    <div class="ddfon">
                            ...
                            <li><i class='y-comp91 <?php if(($order['shop_id'] == 0 and $order[shipping_time] == 0)): ?>top322<?php endif; ?>'></i></li>
                            <?php if($order['shop_id'] == 0): ?>
                            <li>
                                <div class="aloinfe fime3">
                                    <i class='y-comp4 <?php if(($order['shop_id'] == 0 and $order[shipping_time] == 0)): ?>lef64<?php endif; ?>'></i>
                                    <div class="ddfon">
                                        <p>等待收货</p>
                                    </div>
                                </div>
            ...
            <div class="rshrinfmas">
                <?php if($order['shop_id'] > 0): ?>
                   <div class="spff spff-two">
                        ...
                        <div class="psbaowq">
                            ...
                            <p><span class="fircl">提货时间：</span><span class="lascl"><?php echo $order['shop_order']['take_time']; ?></span></p>
                            ...
                            <p><span class="fircl">提货码：</span><span class="lascl"><?php echo $order['shop_order']['shop_order_id']; ?></span></p>
                ...
                <div class="spff spff-two">
                    ...
                    <div class="psbaowq">
                        ...
                        <p><span class="fircl">付款时间：</span><span class="lascl"><?php if($order[pay_status] == 1 or $order[pay_status] == 2): ?><?php echo date('Y-m-d H:i:s',$order['pay_time']); else: ?>未支付<?php endif; ?></span></p>
                        ...
                        <?php if($order['prom_type'] == 4 AND $order['paid_money'] > 0): if($order['pay_status'] == 1): ?>
                            ...
                            <tr>
                                <p><span class="fircl">预售发货时间描述：</span><span class="lascl"><em></em><?php echo $order['pre_sell_info']['pre_sell_deliver_goods']; ?></span></p>
                            </tr>
                        <?php endif; ?>
                        <!-- 预售商品 end -->
                    </div>
                ...
                <div class="spff mar0 spff-two">
                    <h2>发票信息</h2>
                    <div class="psbaowq">
                        <p><span class="fircl">发票类型：</span><span class="lascl"><?php echo (isset($order['invoice'][invoice_type]) && ($order['invoice'][invoice_type] !== '')?$order['invoice'][invoice_type]:'普通发票'); ?></span></p>
                        <p><span class="fircl">发票抬头：</span><span class="lascl"><?php echo $order['invoice_title']; ?></span></p>
                        ...
                        <tr class="conten_or">
                            ...
                            <td class="sx6">
                                <div class="twrbac">
                                    ...
                                    <?php endif; if(($order['order_button']['return_btn'] == 1) and ($goods[is_send] < 2)): ?>
                                        <span>|</span>
                                    ...
                                    <?php if($goods[is_send] == 0 and $order['shop_id'] == 1): ?><a>未发货</a><?php endif; if($goods[is_send] == 1): ?><a>已发货</a><?php endif; if($goods[is_send] > 1): ?><a>已申请售后</a><?php endif; ?>
                                </div>
                            </td>
                        </tr>
                    </table>
