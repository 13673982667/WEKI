<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:47:"./template/mobile/rainbow/order\order_list.html";i:1530846810;s:63:"D:\phpStudy\WWW\shop\template\mobile\rainbow\public\header.html";i:1530846810;s:67:"D:\phpStudy\WWW\shop\template\mobile\rainbow\public\header_nav.html";i:1530846810;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
...
<div class="classreturn loginsignup ">
    <div class="content">
        <div class="ds-in-bl return">
            <a id="[back]" href="<?php echo U('/Mobile/User/index'); ?>"><img src="/template/mobile/rainbow/static/images/return.png" alt="返回"></a>
        </div>
        ...
        <?php endif; if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
            <div class="mypackeg ma-to-20 getmore">
                ...
                <span class="price-alln">
                    ...
                    <span class="red">￥<?php echo $list['total_amount']; ?></span><span class="threel" id="goodsnum">共<?php echo $list['count_goods_num']; ?>件</span>
                    <!--if condition="$list['pay_code'] eq 'cod'"><i class="tits-ions qxatten-ions">货到付款</i></if -->
                        ...
                        <?php endif; if($list['shipping_btn'] == 1): ?>
                            <a class="shop-rebuy" class="shop-rebuy" href="<?php echo U('Mobile/Order/express',array('order_id'=>$list['order_id'])); ?>">查看物流</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
