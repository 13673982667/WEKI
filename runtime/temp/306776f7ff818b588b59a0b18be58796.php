<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:44:"./template/mobile/rainbow/cart\integral.html";i:1534922814;s:63:"D:\phpStudy\WWW\shop\template\mobile\rainbow\public\header.html";i:1530846810;s:67:"D:\phpStudy\WWW\shop\template\mobile\rainbow\public\header_nav.html";i:1530846810;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
...
<div class="classreturn loginsignup ">
    <div class="content">
        <div class="ds-in-bl return">
            <a id="[back]" href="<?php echo $backUrl; ?>"><img src="/template/mobile/rainbow/static/images/return.png" alt="返回"></a>
        </div>
...
<div id="wrapBody">
    <div id="pagePay">
        ...
        <div class="ord_list fill-orderlist p">
            <div class="maleri30">
                <div class="shopprice">
                    <div class="img_or fl"><img src="<?php echo goods_thum_images($goods[goods_id],100,100); ?>"/></div>
                    <div class="fon_or fl">
                        <h2 class="similar-product-text"><?php echo $goods[goods_name]; ?></h2>
                        <div><?php echo $specGoodsPrice[key_name]; ?></div>
                    </div>
                    <div class="price_or fr">
                        <p class="red"><span>￥</span><span><?php echo $goods_price; ?></span></p>
                        <p class="ligfill">x<?php echo $goods_num; ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="maleri30">
                <div class="xx-list">
                    <p class="p">
                        ...
                        <span class="fr red"><span>￥</span><span><?php echo $goods_price * $goods_num; ?></span>元</span>
                    </p>
                    <p class="p">
...
<script type="text/javascript">
    ...
    function submit_order() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo U('Mobile/Cart/integral2'); ?>",//+tab,
