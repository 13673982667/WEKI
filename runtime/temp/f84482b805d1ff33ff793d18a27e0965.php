<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:49:"./template/mobile/rainbow/order\order_detail.html";i:1530846810;s:63:"D:\phpStudy\WWW\shop\template\mobile\rainbow\public\header.html";i:1530846810;s:67:"D:\phpStudy\WWW\shop\template\mobile\rainbow\public\header_nav.html";i:1530846810;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
...
<div class="qqz">
    <div class="maleri30">
        ...
        <?php if($order['order_button']['cancel_btn'] == 1): ?>
...
<div class="information_dr ma-to-20">
    <div class="maleri30">
        ...
        <div class="xx-list">
            ...
            <?php if($order['prom_type'] == 4): if($order['pre_sell_info']['pre_sell_is_finished'] == 2): ?>
                    <p class="p">
    ...
    <div class="maleri30">
        ...
        <div class="xx-list">
            ...
            <?php if($order['prom_type'] == 4 AND $order['paid_money'] > 0): if($order['pay_status'] == 1): ?>
                ...
                <p class="p">
                    <span class="fl">开始发货时间描述</span>
                    <span class="fr"><span><?php echo $order['pre_sell_info']['pre_sell_deliver_goods']; ?></span></span>
                </p>
            <?php endif; ?>
            <!-- 预售商品 end -->
            <p class="p">
...
<div class="payit ma-to-20">
    ...
    <div class="fr s">
        ...
        <?php endif; if($order['prom_type'] == 4 AND $order['pay_status'] == 2 AND $order['pre_sell_info']['pre_sell_is_finished'] == 1 AND (time() >= $order['pre_sell_info']['pre_sell_retainage_start'] AND time() <= $order['pre_sell_info']['pre_sell_retainage_end'])): ?>
